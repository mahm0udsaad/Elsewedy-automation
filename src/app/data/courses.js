...
const allenBradleyCourses = {
  ...
  data:[
    ...
    } , 
    {
      ...
      days: 3 , 
      hours: 20 , 
      link:"public/pdf/Allen bradley courses/AB-13 Allen Bradley Motion Control Fundamentals (Ultra _  Kinetix ).pdf"
    } , 
    {
      code: 'AB-14' , 
  ...
  data: [
    {
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/Allen bradley courses/AB-P1 ControlLogix Fundamentals, Maintenance _ Troubleshooting (RSLogix5000).pdf',
    },
    {
      code: 'AB-P2',
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/Allen bradley courses/AB-P2 ControlLogix Advanced Programming Course.pdf',
    },
    {
      code: 'AB-P3',
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/Allen bradley courses/AB-P3 NetLinx Industrial Communication -EtherNet IP Network, ControlNet _ DeviceNet Communication.pdf',
    },
    {
      code: 'AB-P4',
    ...
    },
    {
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Allen bradley courses/AB-P5 PowerFlex Drives Fundamentals, Configurations and Troubleshooting.pdf',
    },
  ],
};
  ...
  data: [
    {
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Allen bradley courses/AB-L1 PLC5 Maintenance _ Troubleshooting.pdf',
    },
    {
      code: 'AB-L2',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Allen bradley courses/AB-L2 PLC 5 Advanced Programming .pdf',
    },
    {
      code: 'AB-L3',
      ...
      days: 4,
      hours: 30,
      link: 'public/pdf/Allen bradley courses/AB-L3 SLC500 Maintenance _ Troubleshooting.pdf',
    },
    {
      code: 'AB-L4',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Allen bradley courses/AB-L4 SLC500 ADVANCED COURSE .pdf',
    },
    {
      code: 'AB-L5',
      ...
      days: 2,
      hours: 15,
      link: 'public/pdf/Allen bradley courses/AB-L5 RSView32 SCADA..pdf',
    },
  ],
};
  ...
  data: [
    {
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/SIEMENS/SS-01 Siemens Step 7 300-400 via SIMATIC Manager Level_1.pdf',
    },
    {
      code: 'SS-2',
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/SIEMENS/SS-02 Siemens Step 7 300-400 via SIMATIC Manager Level_2.pdf',
    },
    {
      code: 'SS-3',
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/SIEMENS/SS-03 Siemens Step 7 300-400 via SIMATIC Manager Level_3.pdf',
    },
    {
      code: 'SS-4',
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/SIEMENS/SS-04 Siemens Step 7 1200-1500 via TIA Portal Level_1.pdf',
    },
    {
      code: 'SS-5',
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/SIEMENS/SS-05 Siemens Step 7 1200-1500 via TIA Portal Level_2.pdf',
    },
    {
      code: 'SS-6',
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/SIEMENS/SS-06 Siemens Step 7 1200-1500 via TIA Portal Level_3.pdf',
    },
    {
      code: 'SS-7',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/SIEMENS/SS-07 Variable Speed Drive SIEMENS SINAMICS G120 Operator and Maintenance.pdf',
    },
    {
      code: 'SS-8',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/SIEMENS/SS-08 Human Machine Interface (HMI) WinCC flexible SIEMENS.pdf',
    },
    {
      code: 'SS-9',
      ...
      days: 5,
      hours: 30,
      link: 'public/pdf/SIEMENS/SS-09 SIEMENS WinCC SCADA.pdf',
    },
    {
      code: 'SS-10',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/SIEMENS/SS-10 SIEMENS S7 PROFIBUS Network.pdf',
    },
    {
      code: 'SS-11',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/SIEMENS/SS-11 Siemens S7 PROFINET Network.pdf',
    },
    {
  ...
  data: [
    {
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Electrical courses/E-01 Power Cables_ Selection, Testing _ Fault Locations.pdf',
    },
    {
      code: 'E-2',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Electrical courses/E-02 Fault Analysis in Power System.pdf',
    },
    {
      code: 'E-3',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Electrical courses/E-03 Operation, Maintenance _ Troubleshooting of 3 Phase Induction.pdf',
    },
    {
      code: 'E-4',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Electrical courses/E-04 Operation and Maintenance of Circuit Breakers, LV MV Panel, ACB, VCB.pdf',
    },
    {
      code: 'E-5',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Electrical courses/E-05 Power System Protection and Analysis.pdf',
    },
    {
      code: 'E-6',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Electrical courses/E-06 Maintenance of Electrical Switchgears.pdf',
    },
    {
      code: 'E-7',
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Electrical courses/E-07 MAINTENANCE OF POWER TRANSFORMER.pdf',
    },
    {
      code: 'E-8',
  ...
  data: [
    {
      ...
      days: 3,
      hours: 20,
      link: 'public/pdf/Instrumentation Courses/IC-01 Instrumentation and Controls Fundamentals.pdf',
    },
    {
      code: 'IC-2',
      ...
      days: 2,
      hours: 15,
      link: 'public/pdf/Instrumentation Courses/IC-02 Boiler Control System.pdf',
    },
    {
      code: 'IC-3',
      ...
      days: 2,
      hours: 15,
      link: 'public/pdf/Instrumentation Courses/IC-03 Industrial Process Control and tuning.pdf',
    },
    {
      code: 'IC-4',
      ...
      days: 2,
      hours: 15,
      link: 'public/pdf/Instrumentation Courses/IC-04 Process Control and Safety System (PLC,DCS,ESD _ F_G Systems) .pdf',
    },
    {
      code: 'IC-5',
      ...
      days: 2,
      hours: 15,
      link: 'public/pdf/Instrumentation Courses/IC-05 Troubleshooting Instrumentation _ Control System   .pdf',
    },
  ],
};
