...
export const Projects = [
      ...
      content: 
        ...
        <p>El-Sewedy Automation provides integrated solutions for a wide range of industrial applications. As an independent automation solutions provider, El-Sewedy Automation offers its expertise in various third-party hardware to find a fit-for-purpose solution for any process and business needs. The scope covers all project activities from the design phase to the commissioning and start-up phase including the following activities:</p>
         ...
         <ul className="list-disc mt-5 px-5">
          ...
          <li>AC / DC drives configuration and tuning.</li>
          <li>PLC software programming.</li>
          <li>Implementation of HMI and SCADA systems.</li>
          <li>On site Installation.</li>
          <li>Commissioning and start up supervision.</li>
    ...
    },
    {
      ...
      content: 
        ...
        <ul className="list-disc mt-5 mx-5">
          ...
          <li>Selection, supply, and installation of equipment.</li>
          <li>Pipelines and cables supply and installation.</li>
          <li>Isometric installation drawings.</li>
          <li>Design and build for automation system.</li>
    ...
    },
    {
      ...
      content: 
        ...
        <ul className="list-disc mt-5 mx-5">
          ...
          <li>Analyze the data and plan the solution.</li>
          <li>Keep the system operating efficiently during and after the migration.</li>
    ...
    },
    {
      ...
      content: 
        <p>El-Sewedy Automation also can provide program software modification based on customer’s requirements to improve systems stability, increase production rate, adding new features or implement expansion solution which will be integrated with the old system while ensuring that there is no corruption for the original code.</p>
      ,
    },
    {
      title: "SCADA System Implementation",
      content: 
        <p>El-Sewedy Automation Offers a SCADA system for its customer with all required facilities and visualizations system according to standard colorings codes and data clarifications with easy access to trend graphs and system events and reporting system facilities with availability to add Good Manufacturing Practices (GMP) with audit trail.</p>
      ,
    },
    {
      title: "Frequency Drives Installation and Commissioning",
      content: 
        <p>El-Sewedy Automation can supply, install, and program various power rating of frequency drivers with various mode of operations and control methods to serve customer needs.</p>
      ,
    },
    {
