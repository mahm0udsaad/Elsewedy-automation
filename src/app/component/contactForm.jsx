        ...
        <form className="sm:w-full max-w-lg sm:w-5/6 h-fit">
          ...
          <div className="flex flex-wrap -mx-3 h-1/2">
            <div className="w-full px-3">
              ...
              <textarea className=" no-resize appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-20 resize-none" id="message"></textarea>
            </div>
          </div>
          <UploadBtn />
